...
{
	forms_["LoginForm"] = new LoginForm(0, 0, CONSOLE_WIDTH, CONSOLE_HEIGHT);
	forms_["MainMenuForm"] = new MainMenuForm(0, 0, CONSOLE_WIDTH, CONSOLE_HEIGHT);
	forms_["OpenAccountForm"] = new OpenAccountForm(0, 0, CONSOLE_WIDTH, CONSOLE_HEIGHT, "Open Account");
	forms_["DepositForm"] = new DepositForm(0, 0, CONSOLE_WIDTH, CONSOLE_HEIGHT, "Deposit");
	forms_["WithdrawalForm"] = new WithdrawalForm(0, 0, CONSOLE_WIDTH, CONSOLE_HEIGHT, "Withdraw");
	forms_["TransferForm"] = new TransferForm(0, 0, CONSOLE_WIDTH, CONSOLE_HEIGHT, "Transfer");
	forms_["BalanceInquiryForm"] = new BalanceInquiryForm(0, 0, CONSOLE_WIDTH, CONSOLE_HEIGHT, "BalanceInquiry");
	forms_["ChangePasswordForm"] = new ChangePasswordForm(0, 0, CONSOLE_WIDTH, CONSOLE_HEIGHT, "ChangePassword");
	forms_["DetailStatementForm"] = new DetailStatementForm(0, 0, CONSOLE_WIDTH, CONSOLE_HEIGHT, "Detail Statement");
	forms_["CloseAccountForm"] = new CloseAccountForm(0, 0, CONSOLE_WIDTH, CONSOLE_HEIGHT, "Close Account");
	...
	forms_["ReportForm"] = new ReportForm(0, 0, CONSOLE_WIDTH, CONSOLE_HEIGHT);
